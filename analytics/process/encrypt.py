...
def encryption(data):
    ...
    AESによる暗号化を行う
    """
    logger.debug("encryption function called")
    try:
        # ランダムの初期化ベクトルの生成
        ...
        logger.critical("Cloud not encrypt field!")
    return db_data
...
def decryption(data):
    ...
    AESによる復号化を行う
    """
    logger.debug("decryption function called")
    try:
        # dbから読み込んだデータのエンコード
        ...
        logger.critical("Cloud not decrypt field!")
